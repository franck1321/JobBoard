    ...
    <body>
        ...
        <script>
            function add_people() {
                ...
                $.ajax({
                    type: "POST",
                    url: "http://localhost:8888/T-WEB-501-MAR-5-1-jobboard-iliam.amara/admin/function/add_people.php",
                    data: postarg,
            ...
            function show_update(id) {
                console.log("hey")
                var url = "http://localhost:8888/T-WEB-501-MAR-5-1-jobboard-iliam.amara/admin/update_people.php?id=" + id
                window.location = url;
            }
            ...
            function supp_people(check, id_add) {
                ...
                if (check == 1) {
                    ...
                    $.ajax({
                        type: "Post",
                        url: "http://localhost:8888/T-WEB-501-MAR-5-1-jobboard-iliam.amara/admin/function/supp_people.php",
                        data: postarg,
                        success: function(response) {
                            location.reload()
                        }
