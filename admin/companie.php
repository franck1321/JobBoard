...
<body>
    ...
    <script>
        ...
        function go_adds(id) {
            url = "http://localhost:8888/T-WEB-501-MAR-5-1-jobboard-iliam.amara/admin/advertising.php?id=" + id
            window.location = url
        }
        ...
        function up_ese(ese, act) {
            ...
            $.ajax({
                type: "POST",
                url: "http://localhost:8888/T-WEB-501-MAR-5-1-jobboard-iliam.amara/admin/function/change_ese.php",
                data: postarg,
