      ...
      <nav style="display: inline-block;">
        <ul class="pagination">
          <li class="page-item <?= ($currentPage == 1) ? "disabled" : "" ?>">
            <a style="<?= ($currentPage == 1) ? "" : "color: #525252;" ?>background-color: #dbdbdb;" href="accueil.php?page=<?= $currentPage - 1 ?>" class="page-link">Précédente</a>
          </li>
          ...
          <li class="page-item <?= ($currentPage == $pages) ? "disabled" : "" ?>">
            <a style="<?= ($currentPage == $pages) ? "" : "color: #525252;" ?>background-color: #dbdbdb;" href="accueil.php?page=<?= $currentPage + 1 ?>" class="page-link">Suivante</a>
          </li>
        </ul>
        </ul>
      </nav>
